  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Интерьеры,
          <span className="block text-sage">которые говорят тишиной</span>
        </h1>
        ...
        >
          Мы создаём жилые и коммерческие пространства в стиле Japandi — там, где японская строгость встречается со скандинавским уютом. Каждый проект — это баланс между эстетикой и жизнью.
        </p>
